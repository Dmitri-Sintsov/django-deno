...
// import type { ManualChunksOption, ModuleFormat, PreserveEntrySignaturesOption, RollupCache } from "npm:rollup@2.78.0/types.d.ts";
// import type { RollupOptions, OutputOptions } from "npm:rollup@2.78.0/types.d.ts";
import type { ManualChunksOption, ModuleFormat, PreserveEntrySignaturesOption, RollupCache } from "npm:rollup@2.78.0";
import type { RollupOptions, OutputOptions } from "npm:rollup@2.78.0";

import { rollup } from "npm:rollup@2.78.0";
// import { RollupOutput } from "npm:rollup@2.78.0/types.d.ts";
// import { SOURCEMAPPING_URL } from "npm:rollup@2.78.0/utils/sourceMappingURL.ts";
import { RollupOutput } from "npm:rollup@2.78.0";
import { terser } from "npm:@wwa/rollup-plugin-terser";
...
import { denoResolver, DenoResolverOptions } from "./resolver/denoResolver.ts";
...
class RollupBundleSet {
    ...
    public isWritableChunk(baseDirLocalPath: LocalPath, writeBundle: RollupBundleItem | false, chunkObj: any): boolean {
        console.log('RollupBundleSet.isWritableChunk() baseDirLocalPath');
        console.dir(baseDirLocalPath);
        console.log('RollupBundleSet.isWritableChunk() writeBundle');
        console.dir(writeBundle);
        console.log('RollupBundleSet.isWritableChunk() chunkObj.facadeModuleId');
        console.dir(chunkObj.facadeModuleId);
        console.log('RollupBundleSet.isWritableChunk() chunkObj.fileName');
        console.dir(chunkObj.fileName);
        let facadeModuleLocalPath = (chunkObj.facadeModuleId) ?
                baseDirLocalPath.traverseStr(chunkObj.facadeModuleId) : false;
        console.log('RollupBundleSet.isWritableChunk() facadeModuleLocalPath');
        console.dir(facadeModuleLocalPath);
